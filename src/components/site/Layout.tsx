  ...
  return (
    <section className="relative overflow-hidden bg-gradient-hero py-16 text-primary-foreground md:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 text-center md:px-8">
        {eyebrow && <p className="mb-3 text-[10px] font-semibold uppercase tracking-[0.25em] text-gold sm:text-xs sm:tracking-[0.3em]">{eyebrow}</p>}
        <h1 className="text-3xl font-bold sm:text-4xl md:text-6xl">{title}</h1>
        {subtitle && <p className="mx-auto mt-4 max-w-2xl text-base text-primary-foreground/80 sm:mt-5 sm:text-lg">{subtitle}</p>}
